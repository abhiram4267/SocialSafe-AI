...
import { Search, UserCheck, UserMinus, Mail, Phone } from 'lucide-react';
          ...
          <tbody>
            {filteredUsers.map((user) => (
              <tr key={user.id} style={styles.tr}>
                ...
                {/* Date */}
                <td style={styles.td}>
                  <div style={styles.dateText}>{user.created}</div>
                </td>

                {/* Status Pill */}
                <td style={styles.td}>
                  <span style={styles.activePill}>
                    <UserCheck size={12} style={{marginRight: 4}} /> Active
                  </span>
                </td>
              </tr>
            ))}
...
const styles = {
  ...
  activePill: { display: 'inline-flex', alignItems: 'center', backgroundColor: '#dcfce7', color: '#15803d', padding: '4px 12px', borderRadius: '20px', fontSize: '12px', fontWeight: '600' },
